...
WebUI.verifyElementPresent(findTestObject('User/label_SAMPLE TEXT CUSTOMFIELD'), 0)

WebUI.verifyElementText(findTestObject('User/label_SAMPLE TEXT CUSTOMFIELD'), 'SAMPLE TEXT CUSTOMFIELD')

WebUI.verifyElementAttributeValue(findTestObject('User/input_SAMPLE TEXT CUSTOMFIELD_Sample Text Customfield'), 'type', 
    'text', 0)
