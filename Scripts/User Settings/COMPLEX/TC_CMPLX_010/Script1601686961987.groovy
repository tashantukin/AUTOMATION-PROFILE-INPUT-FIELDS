...
WebUI.callTestCase(findTestCase('Utilities/Add new Number customfield'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementAttributeValue(findTestObject('User/input_SAMPLE CUSTOMFIELD NUMBER_Sample Customfield Number'), 'type', 
    'number', 0)
