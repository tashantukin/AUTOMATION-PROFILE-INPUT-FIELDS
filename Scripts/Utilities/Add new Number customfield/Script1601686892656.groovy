...
WebUI.setText(findTestObject('Admin/Plugin Page/Add New Text CF/input_Custom Field Name_custom_name'), 'Sample Customfield Number')

WebUI.selectOptionByValue(findTestObject('Object Repository/Admin/Plugin Page/Add New Text CF/select_Text                                _e22ab6'), 
    'number', true)
