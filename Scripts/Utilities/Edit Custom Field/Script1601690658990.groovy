...
WebUI.setText(findTestObject('Admin/Plugin Page/Add New Text CF/input_Custom Field Name_custom_name'), 'Sample Custom field ')

WebUI.click(findTestObject('Admin/Plugin Page/Add New Text CF/input_Add Option_saveCustomDetails'))

WebUI.click(findTestObject('Object Repository/Admin/Plugin Page/Add New Text CF/i_Textfield_icon icon-edit'))

WebUI.setText(findTestObject('Admin/Plugin Page/Add New Text CF/input_Custom Field Name_custom_name'), 'Sample Custom field Edited')
